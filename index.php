...
// query data koperasi
$koperasi = count(query("SELECT * FROM data_koperasi"));
$pengguna = count(query("SELECT * FROM tb_users"));
                        ...
                        <div class="col-lg-3">
                            <div class="card">
                                <div class="stat-widget-one">
                                    ...
                                    <div class="stat-content dib">
                                        <div class="stat-text">Penggguna</div>
                                        <div class="stat-digit"><?php echo $pengguna; ?></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-3">
                            <div class="card">
                                <div class="stat-widget-one">
                                    ...
                                    <div class="stat-content dib">
                                        <div class="stat-text">Data Koperasi</div>
                                        <div class="stat-digit"><?php echo $koperasi; ?></div>
                                    </div>
                                </div>
                            </div>
                        </div>
